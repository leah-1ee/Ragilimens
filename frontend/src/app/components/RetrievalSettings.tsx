...
export function RetrievalSettings({
  ...
  const handleMethodChange = (method: string) => {
    onConfigChange({
      ...config,
      method: method as 'hybrid' | 'faiss' | 'bm25',
    });
  };
  ...
  const handleLanguageChange = (language: string) => {
    onConfigChange({
      ...config,
      language: language as 'English' | 'Korean',
    });
  };
  ...
  return (
    <Card className="shadow-xl bg-[#080b24]/68 backdrop-blur-md border-2 border-[#d4af37]/40">
      <CardHeader>
        <CardTitle
          className="flex items-center gap-2 text-lg text-[#f4c430]"
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              disabled={disabled}
            >
              <SelectTrigger className="bg-[#05071a]/78 border-[#d4af37]/40 text-[#d4af37]">
                <SelectValue />
              </SelectTrigger>

              <SelectContent className="bg-[#0b1030]/95 border-[#d4af37]/40 text-[#d4af37]">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-[#080b24]/45 border-[#d4af37]/35 text-[#d4af37] hover:bg-[#d4af37]/20"
              >
                -
              </Button>

              <span className="flex-1 text-center font-semibold text-[#d4af37]">
                {config.topK}
              </span>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.chunkConfig}
              onValueChange={handleChunkConfigChange}
              disabled={disabled}
            >
              <SelectTrigger className="bg-[#05071a]/78 border-[#d4af37]/40 text-[#d4af37]">
                <SelectValue />
              ...
              <SelectContent className="bg-[#0b1030]/95 border-[#d4af37]/40 text-[#d4af37]">
                <SelectItem value="structure_text_512">
                  structure_text_512
                </SelectItem>
        ...
        <Collapsible open={showAdvanced} onOpenChange={setShowAdvanced}>
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
              className="w-full justify-between text-[#d4af37] hover:bg-[#d4af37]/20"
              style={{ fontFamily: 'Cinzel, serif' }}
            >
              Advanced Settings
              {showAdvanced ? (
          ...
          <CollapsibleContent className="pt-4 space-y-2">
            ...
            <Textarea
              ...
              onChange={(event) =>
                handleMetadataFilterChange(event.target.value)
              }
              placeholder='{"source_file": "Book4.txt"}'
              className="font-mono text-sm bg-[#05071a]/78 border-[#d4af37]/40 text-[#d4af37] placeholder:text-[#d4af37]/45"
              disabled={disabled}
            />
          </CollapsibleContent>
        </Collapsible>
